...
namespace SmartFPController.Inspector
{
    ...
    {
        private static string MAIN_DATABASE_PATH { get { return SFPCWindow.mainDirectory + "/SurfaceDetector.asset"; } }
        private static string TMP_DATABASE_PATH { get { return SFPCWindow.mainDirectory + "/tmp/SurfaceDetectorTMP.asset"; } }
        ...
        {
            using( SFPCEditorLayout.ScrollView( ref leftScroll, "box", GUILayout.Width( 215f ), GUILayout.ExpandHeight( true ) ) )
            {
                var rld = new SFPCReorderableListDrawer( surfacesList, "Surfaces", SFPCWindow.SetDirtyData );
                rld.HideFoldout();
                rld.DoDraw();
            }
        }
        ...
        private static void ShowRightSide()
        {
            ...
            if( surfacesSize > 0 )
            {
                using( SFPCEditorLayout.Horizontal( "Toolbar" ) )
                {
                    ...
                    if( SFPCEditorHelper.DrawStaticButton( filterBtnLabel, EditorStyles.toolbarDropDown, out filterBtnRect
        ...
        private static void DrawTabList( ReorderableList list, Type targetType )
        {
            ...
            using( SFPCEditorLayout.ScrollView( ref rightScroll, GUILayout.ExpandWidth( true ), GUILayout.ExpandHeight( true ) ) )
            {
                ...
                list.drawElementCallback = ( Rect rect, int index, bool isActive, bool isFocused ) =>
                {
                    ...
                    SFPCEditorHelper.DrawStringPopup( rect, surfaceName, cachedNames );
                ...
                using( new SFPCEditorChangeCheck( SFPCWindow.SetDirtyData ) )
                {
                    ...
                    {
                        SFPCReorderableListDrawer.DoLayoutList( list, SFPCWindow.SetDirtyData );
                    }
                }
